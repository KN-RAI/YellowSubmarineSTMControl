...
#define IMU_GYRO_ACC_ADDR 0b1101011
#define IMU_MAGNETOMETER_ADDR 0b0011110
...
class LSM6
{
  public:
    ...
    vector<float> a_scaled; // accelerometer readings scaled
    vector<float> g_scaled; // gyro readings scaled

    LSM6(void);

    bool init(I2C_HandleTypeDef _hi2c,deviceType device = device_auto, sa0State sa0 = sa0_auto);
